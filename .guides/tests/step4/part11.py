...
"""
Assess part 11, before moving on to the next step.
...
if __name__ == '__main__':
    sys.exit(check_step11(['currency.py','testcurrency.py'],['get_src','get_dst','has_error']))